...
public class AccountServiceImpl implements AccountService {
    ...
    public AccountDTO update(AccountDTO accountDTO) {
        ...
        accountDTODB.setAccountType(accountDTO.getAccountType());
        accountDTODB.setInitialBalance(accountDTO.getInitialBalance());
        accountDTODB.setState(accountDTO.isState());

        Account account = modelMapper.map(accountDTODB, Account.class);
    ...
    public List<AccountReport> getClientAccountReport(Long idClient, LocalDateTime startDate, LocalDateTime endDate) {
        try {
            ...
            // Inicializar la lista para almacenar los reportes de cuentas
